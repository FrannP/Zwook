...
const Decorations = () => {
  ...
  return (
    <div className="invisible xl:visible absolute h-full bg-warningSurface_Light dark:bg-warningSurface_Dark w-[898px] right-0">
...
export default function Login() {
  ...
  return (
    <div className="absolute inset-0 bg-primaryBackground_Light dark:bg-primaryBackground_Dark flex items-center justify-center md:items-start md:justify-start md:flex md:items-center md:justify-center">
      <Decorations />
      <div className="flex flex-col bg-secondaryBackground_Light dark:bg-secondaryBackground_Dark rounded-[16px] border-solid border-[1px] border-primaryBorder_Light dark:border-primaryBorder_Dark gap-[20px] p-[24px] h-[468px] w-[474px] text-primaryText_Light dark:text-primaryText_Dark md:absolute md:top-1/2 md:right-[1172px] md:left-[274px] md:transform md:-translate-y-1/2">
